...
class CaseController extends Controller
{
    public function index()
    {
        ...
        return view('cm.case', compact('cases')); // case.blade.php
    }

    public function show($id)
{
    $service = Service::findOrFail($id); // pakai modelmu
    return view('cm.case', compact('service'));
}
    ...
    {
        return view('cm.newcase'); // newcase.blade.php
    }
...
public function search(Request $request)
{
    ...
    return view('cm.case', ['services' => $case, 'search' => $search]);
}
