...
class CaseController extends Controller
{
    public function index()
    {
        ...
        return view('cs.case', compact('cases')); // case.blade.php
    }

    public function show($id)
{
    $service = Service::findOrFail($id); // pakai modelmu
    return view('cs.case', compact('service'));
} 
    ...
    {
        return view('cs.newcase'); // newcase.blade.php
    }
...
public function search(Request $request)
{
    ...
    return view('cs.case', ['services' => $case, 'search' => $search]);
}
