...
<div class="container-fluid p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1 text-purple">✅ Finish Repair</h2>
            <p class="text-muted mb-0 small">Kelola seluruh case yang sudah selesai diperbaiki</p>
        </div>
    ...
    <div class="glass-card">
        <form action="{{ route('master.finish.logdate') }}" method="GET" class="row g-3 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                @if($start_date || $end_date || $selected_branch)
                    <a href="{{ route('master.finish.logdate') }}" class="btn btn-light border d-flex align-items-center justify-content-center" style="border-radius: 12px; width: 80px;">Reset</a>
                @endif
            </div>
        </form>
    </div>
