...
<div class="container-fluid p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1" style="color: #6a0dad;">📂 View All Cases</h2>
            <p class="text-muted mb-0">Kelola seluruh permintaan perbaikan</p>
        </div>
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('cases.new') }}" class="text-decoration-none">
                <button class="btn-action btn-create shadow-sm">
    ...
    <div class="glass-card">
        <form action="{{ route('ce.case.logdate') }}" method="GET" class="row g-3 align-items-end">
            <div class="col-md-4">
            ...
            <div class="col-md-4 d-flex gap-2">
                <button type="submit" class="btn-action w-100 justify-content-center shadow-sm" style="background: #6a0dad; color: white;">
                    Apply Filter
                </button>
                @if(request('start_date') || request('end_date'))
                    <a href="{{ route('ce.case.index') }}" class="btn btn-light border d-flex align-items-center" style="border-radius: 12px; padding: 10px 20px;">Reset</a>
                @endif
            </div>
        </form>
    </div>
