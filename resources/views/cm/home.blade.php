...
<div class="dashboard-container">
    ...
    <div class="stats-grid">
        ...
        <div class="glass-card stats-card">
            ...
            <div class="circle-stat"><span>{{ $casesInReq }}</span></div>
        </div>
        <div class="glass-card stats-card">
            <h5>Quotation Approved</h5>
            <div class="circle-stat"><span>{{ $casesInApp }}</span></div>
        </div>
          <div class="glass-card stats-card">
            <h5>Quotation Cancelled</h5>
            <div class="circle-stat"><span>{{ $casesInCancl }}</span></div>
        </div>
    </div>
